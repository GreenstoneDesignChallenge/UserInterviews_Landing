...
const myTitle =['Our Goal is to Design a Human and Value Centered Approach Toward A Humans Meaningful Health', 'Scroll Down to help drive the design process']
